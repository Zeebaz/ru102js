...
const updateOptimized = async (meterReading) => {
  ...
  transaction.expireAsync(key, weekSeconds); // expira en una semana
...
const updateBasic = async (meterReading) => {
  ...
  await client.expireAsync(key, weekSeconds); // expira en una semana
...
module.exports = {
  findById,
  update: updateOptimized, // updateBasic | updateOptimized
};
